...
def process_song_file(cur, filepath):
    """Extracts information from given song file and inserts it into the song and artist PostgreSQL database tables"""
...
def process_log_file(cur, filepath):
    """Extracts information from given log file and inserts it into the songplay PostgreSQL database table"""
...
def process_data(cur, conn, filepath, func):
    """Processes data from filepath with given function"""
